...
public class cls_New
{
    ...
    public bool Linq_Them(string new_title, string new_summary, string image, string new_content, string SEO_KEYWORD, string SEO_TITLE, string SEO_LINK, string SEO_DEP, string SEO_IMAGE)
    {
    ...
    public bool Linq_Sua(int new_id, string new_title, string new_summary, string image, string new_content, string SEO_KEYWORD, string SEO_TITLE, string SEO_LINK, string SEO_DEP, string SEO_IMAGE)
    {
