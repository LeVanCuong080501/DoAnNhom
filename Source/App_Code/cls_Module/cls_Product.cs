...
public class cls_Product
{
    ...
    public bool Product_Them(int product_position, string product_title, string image1, string product_summary, string product_content, int product_price, bool product_show, bool product_new, int productcate_id, string SEO_KEYWORD, string SEO_TITLE, string SEO_LINK, string SEO_DEP, string SEO_IMAGE, int vitri)
    {
        ...
        insert.product_position = product_position;
        insert.product_title = product_title;
        if (image1 != "" || image1 != null)
            insert.product_image = image1;
        ...
        insert.product_position = vitri;
        insert.product_show = false;
    ...
    public bool Product_Sua(int product_id, string product_title, string image1, string image2, string image3, string image4, string image5, string summary, string content, int price, int cate, string SEO_KEYWORD, string SEO_TITLE, string SEO_LINK, string SEO_DEP, string SEO_IMAGE, int vitri)
    {
        ...
        //update.product_show = false;
        // update.product_new = product_new;
