...
public class cls_ProductCate
{
    ...
    public bool Linq_Them(string productcate_title, int parent, string vitri, bool productcate_show, string noidung, string SEO_KEYWORD, string SEO_TITLE, string SEO_LINK, string SEO_DEP, string SEO_IMAGE)
    {
        ...
        insert.productcate_show = productcate_show;
    ...
    public bool Linq_Sua(int productcate_id, string productcate_title, int parent,string vitri, bool productcate_show, string noidung, string SEO_KEYWORD, string SEO_TITLE, string SEO_LINK, string SEO_DEP, string SEO_IMAGE)
    {
