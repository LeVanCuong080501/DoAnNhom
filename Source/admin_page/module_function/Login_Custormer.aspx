        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="block_Login">
                    ...
                    <div class="row" style="padding: 5% 0">
                        <a class="button_login" id="btnLogin" runat="server">Log In</a>
                    </div>
                    <div class="row">
                        <h6>If you dont have account, click to </h6>
                        <a data-toggle="modal" data-target="#myModal" class="button_signup" id="btnSignup" runat="server">Sign up</a>
                    </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer akk">
                                    <asp:UpdatePanel ID="uporder" runat="server">
                                        <ContentTemplate>
                                            <button type="button" id="btn_send" class="btn btn-lienhe" data-dismiss="modal" runat="server">Sign Up</button>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                            </div>
