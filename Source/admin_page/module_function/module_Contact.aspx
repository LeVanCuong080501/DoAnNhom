<%@ Page Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_Contact.aspx.cs" Inherits="admin_page_module_function_module_Contact" %>
        ...
        <div class="form-group table-responsive">
            <dx:ASPxGridView ID="grvList" runat="server" ClientInstanceName="grvList" KeyFieldName="contact_id" Width="100%">
                <Columns>
                    ...
                    <dx:GridViewDataColumn Caption="Tên" FieldName="contact_name" HeaderStyle-HorizontalAlign="Center" Width="20%"></dx:GridViewDataColumn>
                    ...
                    <dx:GridViewDataColumn Caption="Email" FieldName="contact_email" Settings-AllowEllipsisInText="True" HeaderStyle-HorizontalAlign="Center" Width="20%"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Link" FieldName="contact_link" Settings-AllowEllipsisInText="True" HeaderStyle-HorizontalAlign="Center" Width="20%"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Điện thoại" FieldName="contact_hotline" HeaderStyle-HorizontalAlign="Center" Width="18%"></dx:GridViewDataColumn>
                                ...
                                <div class="col-12">
                                    <div class="col-9">
                                        <div class="col-12 form-group">
                                            <label class="col-2 form-control-label">Tên Tiệm:</label>
                                            <div class="col-10">
                                                <asp:TextBox ID="txtTen" runat="server" ClientIDMode="Static" CssClass="form-control boxed" Width="95%"> </asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-12 form-group">
                                        ...
                                        <div class="col-12 form-group">
                                            ...
                                            <div class="col-10">
                                                <asp:TextBox ID="txtLink" runat="server" ClientIDMode="Static" CssClass="form-control boxed" Width="95%"> </asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-12 form-group">
