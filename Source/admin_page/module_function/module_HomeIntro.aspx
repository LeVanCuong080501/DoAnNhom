<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_HomeIntro.aspx.cs" Inherits="admin_page_module_function_module_HomeIntro" %>
        ...
        <div class="form-group row">
            <div class="col-sm-10">
                <asp:UpdatePanel ID="udButton" runat="server">
                    <ContentTemplate>
                        <asp:Button ID="btnThem" runat="server" Text="Thêm" CssClass="btn btn-primary hidden-xs-up" OnClick="btnThem_Click" />
                        <asp:Button ID="btnChiTiet" runat="server" Text="Chi tiết" CssClass="btn btn-primary" OnClick="btnChiTiet_Click" />
                        <input type="submit" class="btn btn-primary hidden-xs-up" value="Xóa" onclick="confirmDel()" />
        ...
        <div class="form-group table-responsive">
            <dx:ASPxGridView ID="grvList" runat="server" ClientInstanceName="grvList" KeyFieldName="intro_id" Width="100%">
                <Columns>
                    ...
                    <dx:GridViewDataColumn Caption="Tiêu đề" FieldName="intro_title" HeaderStyle-HorizontalAlign="Center" Width="70%"></dx:GridViewDataColumn>
                   <dx:GridViewDataColumn Caption="Ngày tạo" FieldName="intro_createdate" HeaderStyle-HorizontalAlign="Center" Width="20%"></dx:GridViewDataColumn>
                </Columns>
