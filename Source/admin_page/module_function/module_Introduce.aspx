        ...
        <div class="form-group table-responsive">
            <dx:ASPxGridView ID="grvList" runat="server" ClientInstanceName="grvList" KeyFieldName="introduct_id" Width="100%">
                <Columns>
                    ...
                    <dx:GridViewDataColumn Caption="Nội dung" FieldName="introduce_content" Settings-AllowEllipsisInText="True" HeaderStyle-HorizontalAlign="Center" Width="50%"></dx:GridViewDataColumn>
