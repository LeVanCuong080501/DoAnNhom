...
public partial class admin_page_module_function_module_Introduce : System.Web.UI.Page
{
    ...
    protected void btnLuu_Click(object sender, EventArgs e)
    {
        ...
        String folderUser = Server.MapPath("~/uploadimages/anhgioithieu/");
        ...
        {
            string ulr = "/uploadimages/anhgioithieu/";
            string filename = (FileUpload1.FileName);
            string fileName_save = Path.Combine(Server.MapPath("~/uploadimages/anhgioithieu"), filename);
        ...
        else
        {
            ...
            {
                if (cls.Linq_Them(txtTitle.Text, txtTitle1.Text, edtnoidung.Html, image, KEYWORD, TitleSeo, Link, Dep, ImageSeo))
                {
            ...
            else
            {
                ...
                if (cls.Linq_Sua(Convert.ToInt32(Session["_id"].ToString()), txtTitle.Text, txtTitle1.Text, edtnoidung.Html, image, KEYWORD, TitleSeo, Link, Dep, ImageSeo))
                {
