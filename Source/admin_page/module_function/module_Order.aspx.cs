...
public partial class admin_page_module_function_module_Order : System.Web.UI.Page
{
    ...
    private void loadData()
    {
        ...
        //grvList.DataBind();
        var getdata = from or in db.tbOrders
                      where  or.order_active==true
                      orderby or.order_id descending
                      select new
                      {
                          or.order_id,
                          or.order_custumer,
                          ...
                          or.order_thanhtien,
                          or.order_phone,
                          tinhtrang = or.order_submit == false ? "Chưa xem" : "Đã xem",
                      };
        grvList.DataSource = getdata;
        grvList.DataBind();
    }
