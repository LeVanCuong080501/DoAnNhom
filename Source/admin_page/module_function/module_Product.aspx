            ...
            <div class="col-sm-10">
                <asp:UpdatePanel ID="udButton" runat="server">
                    <ContentTemplate>
                        ...
                        <%--<asp:Button ID="btnVip" runat="server" CssClass="btn btn-primary" Text="Sản phẩm tiêu biểu" OnClick="btnVip_Click" />--%>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
        </div>
        <div class="form-group table-responsive">
            <dx:ASPxGridView ID="grvList" runat="server" ClientInstanceName="grvList" KeyFieldName="product_id" Width="100%">
                <Columns>
                    ...
                    <dx:GridViewDataColumn Caption="Nhóm sản phẩm" FieldName="productcate_title" HeaderStyle-HorizontalAlign="Center" Width="15%"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Tên sản phẩm" FieldName="product_title" HeaderStyle-HorizontalAlign="Center" Width="15%"></dx:GridViewDataColumn>
                     <dx:GridViewDataColumn Caption="Vị trí trang chủ" FieldName="product_position" HeaderStyle-HorizontalAlign="Center" Width="15%"></dx:GridViewDataColumn>
                    <%--<dx:GridViewDataColumn Caption="Tóm tắt" FieldName="product_summary" HeaderStyle-HorizontalAlign="Center" Width="30%"></dx:GridViewDataColumn>--%>
                    <%--<dx:GridViewDataColumn Caption="Sản phẩm tiểu biểu" FieldName="product_tieubieu" HeaderStyle-HorizontalAlign="Center" Width="15%"></dx:GridViewDataColumn>--%>
                    <dx:GridViewDataTextColumn FieldName="product_price" Caption="Giá" Width="10%" HeaderStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" VisibleIndex="4">
                        <PropertiesTextEdit DisplayFormatString="{0:#,0.##}" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataColumn FieldName="product_image" Width="30%" Caption="Hình ảnh" HeaderStyle-HorizontalAlign="Center" CellStyle-VerticalAlign="Middle">
                        <DataItemTemplate>
                            <img src="<%#Eval("product_image") %>" height="100" />
                        </DataItemTemplate>
                    </dx:GridViewDataColumn>
                    <%--<dx:GridViewDataColumn Width="15%" Caption="Xem chi tiết" HeaderStyle-HorizontalAlign="Center" CellStyle-VerticalAlign="Middle">
                        <DataItemTemplate>
                            <a target="_blank" class="btn btn-link" href="/san-pham-chi-tiet/<%#cls_ToAscii.ToAscii(Eval("product_title").ToString()) %>-<%#Eval("product_id") %>.html"><i class="fa fa-eye"></i>&nbsp;Chi tiết</a>
                        </DataItemTemplate>
                    </dx:GridViewDataColumn>--%>
                </Columns>
                            ...
                            <div class="div_content col-12">
                                <div class="col-12">
                                    <div class="col-12 form-group">
                                        ...
                                        <div class="col-4">
                                            <dx:ASPxComboBox ID="ddlNhomSanPham" runat="server" ValueType="System.Int32" TextField="productcate_title" ValueField="productcate_id" ClientInstanceName="ddlNhomSanPham" CssClass="" Width="95%"></dx:ASPxComboBox>
                                        </div>
                                    </div>
                                    <div class="col-12 form-group">
                                    ...
                                    <div class="col-12 form-group">
                                        <label class="col-2 form-control-label">Vị trí trang chủ:</label>
                                        <div class="col-4">
                                            <asp:TextBox ID="txtPosition" runat="server" ClientIDMode="Static" CssClass="form-control boxed" Width="95%"> </asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-12 form-group">
                                        <label class="col-2 form-control-label">Giá:</label>
                                        <div class="col-4">
                                            <asp:TextBox ID="txtgia" runat="server" ClientIDMode="Static" CssClass="form-control boxed" Width="88%"> </asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-12 form-group">
                                        <label class="col-2 form-control-label">Tóm tắt:</label>
                                        <div class="col-10">
                                            <asp:TextBox ID="txttomtat" runat="server" ClientIDMode="Static" CssClass="form-control boxed" Width="98%"> </asp:TextBox>
                                        </div>
                                    </div>
                                  <div class="col-12">
                                        <div class="text-color1"><i>Kích thước ảnh tiêu chuẩn 800x800</i></div>
                                        <div class="colum-5 form-group">
                                            <label class="form-control-label">Hình ảnh 1:</label>
                                            <div id="up1" class="">
                                   ...
                                   <%--     <div class="colum-5 form-group">
                                            <label class="form-control-label">Hình ảnh 2:</label>
                                            <div id="up2" class="">
                                                ...
                                                <button type="button" class="btn-chang" onclick="clickavatar2()">
                                                    <img id="imgPreview2" src="/admin_images/up-img.png" style="width: 100%" />
                                                </button>
                                            </div>
                                        </div>
                                        <div class="colum-5 form-group">
                                            <label class="form-control-label">Hình ảnh 3:</label>
                                            <div id="up3" class="">
                                                ...
                                                <button type="button" class="btn-chang" onclick="clickavatar3()">
                                                    <img id="imgPreview3" src="/admin_images/up-img.png" style="width: 100%" />
                                                </button>
                                            </div>
                                        </div>
                                        <div class="colum-5 form-group">
                                            <label class="form-control-label">Hình ảnh 4:</label>
                                            <div id="up4" class="">
                                                <asp:FileUpload CssClass="hidden-xs-up" ID="FileUpload4" runat="server" onchange="showPreview4(this)" />
                                                <button type="button" class="btn-chang" onclick="clickavatar4()">
                                                    <img id="imgPreview4" src="/admin_images/up-img.png" style="width: 100%" />
                                                </button>
                                            </div>
                                        </div>
                                        <div class="colum-5 form-group">
                                            <label class="form-control-label">Hình ảnh 5:</label>
                                            <div id="up5" class="">
                                                <asp:FileUpload CssClass="hidden-xs-up" ID="FileUpload5" runat="server" onchange="showPreview5(this)" />
                                                <button type="button" class="btn-chang" onclick="clickavatar5()">
                                                    <img id="imgPreview5" src="/admin_images/up-img.png" style="width: 100%" />
                                                </button>
                                            </div>
                                        </div>--%>
                                    </div>
