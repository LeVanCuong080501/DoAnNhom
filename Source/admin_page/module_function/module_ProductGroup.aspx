<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_ProductGroup.aspx.cs" Inherits="admin_page_module_function_module_ProductGroup" %>
        ...
        <div class="form-group table-responsive">
            <dx:ASPxGridView ID="grvList" runat="server" ClientInstanceName="grvList" KeyFieldName="productcate_id" Width="100%">
                <Columns>
                    ...
                    <dx:GridViewDataColumn Caption="Nhóm sản phẩm" FieldName="productcate_title" HeaderStyle-HorizontalAlign="Center" Width="50%"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Vị trí" FieldName="productcate_position" HeaderStyle-HorizontalAlign="Center" Width="20%"></dx:GridViewDataColumn>
                    <%-- <dx:GridViewDataColumn Caption="Tình trạng" FieldName="productgroup_show" HeaderStyle-HorizontalAlign="Center" Width="30%"></dx:GridViewDataColumn>--%>
                </Columns>
                    ...
                    <ContentTemplate>
                        <div class="popup-main">
                            ...
                            <div class="col-12">
                                ...
                                <div class="col-12 form-group">
                                    <div class="col-12">
                                        <dx:ASPxHtmlEditor ID="edtnoidung" ClientInstanceName="edtnoidung" runat="server" Width="100%" Height="450px" Border-BorderStyle="Solid" Border-BorderWidth="1px" Border-BorderColor="#dddddd">
