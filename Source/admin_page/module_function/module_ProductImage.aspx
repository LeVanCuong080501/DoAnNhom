<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_ProductImage.aspx.cs" Inherits="admin_page_module_function_module_ProductImage" %>
        ...
        <div class="form-group table-responsive">
            <dx:ASPxGridView ID="grvList" runat="server" ClientInstanceName="grvList" KeyFieldName="product_id" Width="100%">
                <Columns>
                    ...
                    <dx:GridViewDataColumn Caption="Loại sản phẩm" FieldName="productcate_title" HeaderStyle-HorizontalAlign="Center" Width="15%"></dx:GridViewDataColumn>
                    ...
                    <dx:GridViewDataColumn FieldName="product_image" Width="30%" Caption="Hình ảnh" HeaderStyle-HorizontalAlign="Center" CellStyle-VerticalAlign="Middle">
                        <DataItemTemplate>
                            <img src="uploadimages/products/<%#Eval("product_image") %>" height="100" />
                        </DataItemTemplate>
