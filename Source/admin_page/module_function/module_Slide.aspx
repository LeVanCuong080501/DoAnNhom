...
<asp:Content ID="Content5" ContentPlaceHolderID="hibodywrapper" runat="Server">
            ...
            <div class="col-sm-10">
                <asp:UpdatePanel ID="udButton" runat="server">
                    <ContentTemplate>
                        ...
                        <%--<asp:Button ID="btnTop" runat="server" Text="Top" CssClass="btn btn-primary" OnClick="btnTop_Click" />--%>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
        </div>
    ...
    <dx:ASPxPopupControl ID="popupControl" runat="server" Width="1200px" Height="400px" CloseAction="CloseButton" ShowCollapseButton="True" ShowMaximizeButton="True" ScrollBars="Auto" CloseOnEscape="true" Modal="True"
                    ...
                    <ContentTemplate>
                        <div class="popup-main">
                            <div class="div_content col-12">
                                <div class="col-12">
                                    <div class="col-8">
                                        <div class="col-12 form-group">
                                            <label class="col-1 form-control-label">Link dẫn:</label>
                                            <div class="col-10">
                                                <asp:TextBox ID="txtLink" runat="server" ClientIDMode="Static" CssClass="form-control boxed" Width="96%"> </asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-12 form-group">
                                            <label class="col-1 form-control-label">Tiêu đề:</label>
                                            <div class="col-10">
                                                <div class="col-12 form-group">
                                                    <div class="col-12">
                                                        <dx:ASPxHtmlEditor ID="edttieude" ClientInstanceName="edttieude" runat="server" Width="100%" Height="200px" Border-BorderStyle="Solid" Border-BorderWidth="1px" Border-BorderColor="#dddddd">
                                ...
                                <%--</div>--%>
                                <%--  <div class="col-12 form-group">
                                        <label class="col-2 form-control-label">Tiêu đề 2:</label>
                                        <div class="col-10">
                                            <%--<asp:TextBox ID="txttensanpham" runat="server" ClientIDMode="Static" CssClass="form-control boxed" Width="90%"> </asp:TextBox>
                                            <div class="col-12 form-group">
                                                <div class="col-12">
                                                    <dx:ASPxHtmlEditor ID="edttieude2" ClientInstanceName="edttieude2" runat="server" Width="100%" Height="200px" Border-BorderStyle="Solid" Border-BorderWidth="1px" Border-BorderColor="#dddddd">
                                                        <SettingsHtmlEditing EnablePasteOptions="true" />
                                                        <Settings AllowHtmlView="true" AllowContextMenu="Default" />
                                                        <settingsimageupload uploadfolder="~/editorimages"></settingsimageupload>
                                                        <Toolbars>
