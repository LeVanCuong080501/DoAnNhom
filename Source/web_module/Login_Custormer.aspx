            ...
            <div class="col-lg-6">
                <asp:Repeater ID="rpContact" runat="server">
                    <ItemTemplate>
                        ...
                        <h3 style="color: #333333; font-size: 24px; line-height: 24px; border-bottom: none; padding: 0">Địa chỉ :<%#Eval("contact_address") %></h3>
                        <h3 style="color: #333333; font-size: 24px; line-height: 24px; border-bottom: none; padding: 0">Email :&nbsp;<a href="mailto:<%#Eval("contact_email") %>"><span style="color: #000000"><%#Eval("contact_email") %></span></a></h3>
                        <h3 style="color: #333333; font-size: 24px; line-height: 24px; border-bottom: none; padding: 0">Website :&nbsp;<a href="http://<%#Eval("contact_link") %>/"><span style="color: #000000"><%#Eval("contact_link") %></span></a></h3>
                        <h3 style="color: #333333; font-size: 24px; line-height: 24px; border-bottom: none; padding: 0"><span style="color: #B22222"><strong>Hotline</strong>:&nbsp;<strong><%#Eval("contact_hotline") %></strong></span></h3>
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
                       <%-- <p>
            ...
            <div class="col-lg-6">
                <div class="block_Login">
                    ...
                    <div class="row" style="padding: 5% 0">
                        <input placeholder="Password" class="input_login" type="password" id="txtPassword" runat="server" />
                    </div>
                    <div class="row">
                        <div class="col-lg-10">
                                ...
                                <div class="modal-body">
                                    <div class="form-popup">
                                        <div class="form-group col-lg-6">
                                            <input class="form-control" type="text" runat="server" id="txt_FName" onkeypress="return isTextKey(event)" placeholder="First name" />
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <input class="form-control" type="text" runat="server" id="txt_SName" onkeypress="return isTextKey(event)" placeholder="Surname" />
                                        </div>
                                        <div class="form-group akk">
                                            <input class="form-control" type="text" runat="server" id="txt_Username" placeholder="Your username" />
                                        </div>
                                        <div class="form-group akk">
                                            <input class="form-control" type="password" runat="server" id="txt_PassWord" placeholder="New password" />
                                        </div>
                                        <div class="form-group akk">
                                            <input class="form-control" type="password" runat="server" id="txt_RPassword" placeholder="Repeat your password" />
                                        </div>
                                        <div class="form-group akk">
